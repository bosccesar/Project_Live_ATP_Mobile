...
public class StatMatchBDD {
    ...
    public StatMatchBDD(int idJeu, int idJoueur, int idSet, boolean filet, int idPoint, boolean out, int idRencontre, int nombreService, boolean ace, String libelle, boolean secondService, boolean serviceReussi) {
        this.idJeu = idJeu;
